...
function BlockFile_create(filename, metaProps_, createcb) {
...
function BlockFile_open(filename, metaProps, opencb) {
...
//  if (arguments.length == 2) {
  ...
  //DEL if (args.length < 1 || args.length > 3)
  //DEL   throw new Error(format("wrong number of open() args %d", args.length))
...
function BlockFile__initialize(stat, initcb) {
