...
//REPLACED:        return this.numHandleBits - this.spanNumBits - this.blkNumBits
//REPLACED:      }
//REPLACED:    , enumerable: true }
//REPLACED:  , blockSize:
//REPLACED:    { get: function(){ return pow(2, this.blockSzBits) }
//REPLACED:    , enumerable: true }
//REPLACED:  , numBlkNums   :
//REPLACED:    { get: function(){ return toBits(this.fsmSize) - this.checkSumBits }
//REPLACED:    , enumerable: true }
//REPLACED:  , minBlkNum: { value: 0, enumerable: true }
//REPLACED:  , maxBlkNum    :
//REPLACED:    { get: function(){ return this.numBlkNums-1 }
//REPLACED:    , enumerable: true }
//REPLACED:  , numSegNums   :
//REPLACED:    { get: function(){ return pow(2, this.segNumBits) }
//REPLACED:    , enumerable: true }
//REPLACED::  , minSegNum: { value: 0, enumerable: true }
//REPLACED:  , maxSegNum    :
//REPLACED:    { get: function(){ return this.numSegNums-1 }
//REPLACED:    , enumerable: true }
//REPLACED:  , numSpanNums  :
//REPLACED:    { get: function(){ return pow(2, this.spanNumBits) }
//REPLACED:    , enumerable: true }
//REPLACED:  , minSpanNum: { value: 0, enumerable: true }
//REPLACED:  , maxSpanNum   :
//REPLACED:    { get: function(){ return this.numSpanNums-1 }
//REPLACED:    , enumerable: true }
//REPLACED:  , segNumShift  : { value: 0 }
//REPLACED:  , segNumMask   :
//REPLACED:    { get: function(){ return pow(2, this.segNumBits)-1 }
//REPLACED:    , enumerable: true }
//REPLACED:  , blkNumBits   :
//REPLACED:    { get: function(){ return ceil(log2(this.numBlkNums)) }
//REPLACED:    , enumerable: true }
//REPLACED:  , blkNumShift  :
//REPLACED:    { get: function(){ return this.segNumBits }
//REPLACED:    , enumerable: true }
//REPLACED:  , blkNumMask   :
//REPLACED:    { get: function(){ return pow(2, this.blkNumBits)-1<<this.blkNumShift }
//REPLACED:    , enumerable: true }
//REPLACED:  , spanNumShift :
//REPLACED:    { get: function(){ return this.segNumBits+this.blkNumBits }
//REPLACED:    , enumerable: true }
//REPLACED:  , spanNumMask  :
//REPLACED:    { get: function(){ return pow(2, this.spanNumBits)-1<<this.spanNumShift }
//REPLACED:    , enumerable: true }
//REPLACED:  , fsmSize      :
//REPLACED:    { get: function(){ return pow(2, this.fsmSzBits) }
//REPLACED:    , enumerable: true }
//REPLACED:  , segHdrSize   :
//REPLACED:    { get: function(){ return 2*this.fsmSize }
//REPLACED:    , enumerable: true }
//REPLACED:  , fsmOffsetPrimary:
//REPLACED:    { value: 0, enumerable: true }
//REPLACED:  , fsmOffsetSecondary:
//REPLACED:    { get: function(){ return this.fsmSize }
//REPLACED:    , enumerable: true }
//  , numBlksSeg //isn't that just numBlkNums
//REPLACED:  , maxSegSize:
//REPLACED:    { get: function(){ return this.segHdrSize + this.numBlkNums*this.blockSize }
//REPLACED:    , enumerable: true }
...
//UNUSED:Props.prototype.maxNumBlks = function(){
//UNUSED:  return this.numSegNums() * this.numBlkNums()
//UNUSED:}
...
Props.prototype.maxSegSize = function(){
  return this.numSegNums() *
    ( this.segHdrSize() + ( this.numBlkNums() * this.blockSize() ) )
}

//UNUSED:Props.prototype.maxFileSize = function(){
//UNUSED:  return this.numSegNums() * this.maxSegSize()
//UNUSED:}

//UNUSED:Props.prototype.maxDataSize = function(){
//UNUSED:  return this.numSegNums() * this.numBlkNums() * this.blockSize()
//UNUSED:}
