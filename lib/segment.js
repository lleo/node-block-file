...
function Segment(segNum, buffer, fsmType) {
  ...
  //A!assert.ok( Buffer.isBuffer(buffer), "argument buffer is not a Buffer" )
  //A!assert.strictEqual(buffer.length, FSM_SIZE)
  //A!assert.equal(typeof fsmType, 'function', "argument fsmType is not a Function")
